...
* @Date:   2017-03-01T09:06:58+07:00
* @Email:  hotro@onemax.com.vn
* @Project: Onemax
* @Last modified by:   onemax
* @Last modified time: 2017-03-01T10:06:48+07:00
...
(function() {
    ...
    (new WebNotifier({
        fetch_url:'/notification/register',
        service_worker_url:'service-worker.js'
    }))
    .start( function(error, message, subscribe) {
        console.log( error, message, subscribe );
    } );
})();
